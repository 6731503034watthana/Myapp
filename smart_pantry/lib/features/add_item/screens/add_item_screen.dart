...
class AddItemScreen extends StatelessWidget {
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        GestureDetector(
                          onTap: () =>
                              _showCreateCategoryDialog(context, catProvider),
                          child: Container(
                      ...
                      child: Center(
                        child: Column(
                          children: [
                            ...
                            const SizedBox(height: 8),
                            Text('Tap "Create" to add your first category',
                                style: TextStyle(
                    ...
                    GridView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return _CategoryTile(
                          category: cat,
                          onTap: () =>
                              context.push(AppRoutes.addItemForm, extra: cat),
                          onLongPress: () =>
                              _showDeleteDialog(context, catProvider, cat),
                        );
                      },
                    ),
  ...
  void _showDeleteDialog(
      BuildContext context, CategoryProvider catProvider, FoodCategory cat) {
    showDialog(
      context: context,
      builder: (ctx) => AlertDialog(
        ...
        content: const Text(
            'This will remove the category. Items using it will show as uncategorized.'),
        actions: [
          TextButton(
              onPressed: () => Navigator.pop(ctx),
      ...
      child: Container(
        decoration: BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: [category.color, category.color.withAlpha(204)],
          ),
