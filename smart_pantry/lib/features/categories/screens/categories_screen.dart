...
class CategoriesScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Consumer2<FoodItemsProvider, CategoryProvider>(
                    ...
                    child: categories.isEmpty
                        ...
                        : GridView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return CategoryCard(
                                category: category,
                                itemCount: provider.getCategoryCount(category),
                    ...
                    child: Column(children: [
                      Container(
                        ...
                        child: Row(children: [
                          ...
                          Text(
                            '${selectedCategory.label} (${provider.filteredItems.length} items)',
                            style: TextStyle(fontSize: 18, fontWeight: FontWeight.w700, color: selectedCategory.color),
                          ),
                        ]),
                      ),
                      Expanded(
                            ...
                            : ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  return Padding(
                                    ...
                                    child: FoodItemCard(item: item, onTap: () => context.push('${AppRoutes.itemDetail}/${item.id}')),
                                  );
                                },
                              ),
                      ),
